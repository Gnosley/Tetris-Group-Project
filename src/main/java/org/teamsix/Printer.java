...
public class Printer {
    ...
    private String[] getLeftSide(Block[][] holdArray,
        ...
        for(int i = 0; i < arrayOfRows.length; i++) {
            ...
            // The stats
                ...
                arrayOfRows[i] += getStatsString(i - STATSTOP);
            }
     ...
     */
    private int getTetrominoData(int tetrominoType) {
        return 12731;
    }
     ...
     */
    private String getStatsString(int row) {
        ...
        case 11: return centerString(formatNumber(getTetrominoData(7), 6), LEFTWIDTH);
        }
        String rowStr = tetrominoType
            + ": "
            + formatNumber(getTetrominoData(row - 2), 6);
