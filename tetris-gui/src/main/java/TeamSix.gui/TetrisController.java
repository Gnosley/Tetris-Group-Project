...
public class TetrisController {
    ...
    public void storeTetromino() {
        ...
        String[] tetrominoFXML_URL = new String[]{"./ITetromino.fxml","./OTetromino.fxml","./TTetromino.fxml",
                "./STetromino.fxml" ,"./ZTetromino.fxml","./JTetromino.fxml","./LTetromino.fxml"};
    ...
    public void addBlock(int layoutX, int layoutY, int blockColor) {
        ...
        try {
            block = FXMLLoader.load(getClass().getResource("./Block.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void loadMainMenu(MouseEvent event) throws IOException {
        ...
        Parent tetrisRoot = FXMLLoader.load(getClass().getResource("./TetrisMenu.fxml"));
